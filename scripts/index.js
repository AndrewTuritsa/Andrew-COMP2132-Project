...
const game = {
    ...
    rollDice() {
        ...
        // Show images and start animation
        ...
        // Start animation
        setTimeout(() => {
            lightningImg.style.transform = 'translateX(300px)';
            skullImg.style.transform = 'translateX(-300px)';
        }, 10);

        // Hide images and reset animation after 1 second
        setTimeout(() => {
        ...
        // Check if both players have rolled 3 times
        if (this.player1.rollCount === 3 && this.player2.rollCount === 3) {
            setTimeout(() => {
                ...
                if (this.player1.total > this.player2.total) {
                    ...
                    imageSrc = '../images/magicBook.png'; // Replace with the actual path to the image
                } else if (this.player2.total > this.player1.total) {
                    message = "The Necromancer Wins!";
                    imageSrc = '../images/grave.png'; // Replace with the actual path to the image
                } else {
                    message = "Tie!";
                    imageSrc = '../images/magicBook.png'; // Replace with the actual path to the image
                }
